...
pub fn api_routes() -> Router<AppState> {
    Router::new()
        ...
        .route(
            "/moments/{moment_id}",
            get(moments::get_one).put(moments::edit).delete(moments::delete_moment),
        )
        .route(
        ...
        .route("/me/quota/debug-reset", post(me::quota_debug_reset))
        .route("/me/quota", get(me::quota_status))
